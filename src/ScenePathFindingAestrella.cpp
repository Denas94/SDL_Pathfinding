...
void ScenePathFindingAestrella::update(float dtime, SDL_Event *event)
{
...
void ScenePathFindingAestrella::draw()
{
	drawMaze();
	drawCoin();
...
const char* ScenePathFindingAestrella::getTitle()
{
	return "SDL Steering Behaviors :: BFS Demo";
}

void ScenePathFindingAestrella::drawMaze()
{
	if (draw_grid)
	{
...
void ScenePathFindingAestrella::drawCoin()
{
...
void ScenePathFindingAestrella::initMaze()
{
...
void ScenePathFindingAestrella::initGraph() {
...
bool ScenePathFindingAestrella::loadTextures(char* filename_bg, char* filename_coin)
{
...
Vector2D ScenePathFindingAestrella::cell2pix(Vector2D cell)
{
	int offset = CELL_SIZE / 2;
	return Vector2D(cell.x*CELL_SIZE + offset, cell.y*CELL_SIZE + offset);
}

Vector2D ScenePathFindingAestrella::pix2cell(Vector2D pix)
{
	return Vector2D((float)((int)pix.x/CELL_SIZE), (float)((int)pix.y / CELL_SIZE));
}

bool ScenePathFindingAestrella::isValidCell(Vector2D cell)
{
